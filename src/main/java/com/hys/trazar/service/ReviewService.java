...
public class ReviewService {
	...
	public List<ReviewDto> getReviewByDesignBoardId(int designBoardId) {
		
		return mapper.selectAllDesignBoardId(designBoardId, null);
	}
	...
	public List<ReviewDto> getReviewWithOwnByDesignBoardId(int designBoardId, String memberId) {
