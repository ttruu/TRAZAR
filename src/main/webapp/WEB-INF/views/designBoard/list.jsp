...
<body>
   ...
   <section class="list-titles">
      <form action="${appRoot}/designBoard/list" method="get">
         <ul class="nav row"
            style="padding-bottom: 1%; justify-content: center;">
                        ...
                        <c:forEach items="${designBoardList }" var="designBoard">
                           <div class="col-3 col-3-medium col-8-small">
                                 ...
                                 <a href="${getUrl }" class="image featured">
                                    ...
                                    <div class="design-name">${designBoard.title }</div>
                                 
                                 <div class="design-name">${designBoard.writerNickName }</div>
                                 <div class="main-project-title">${designBoard.prettyInserted }</div>
