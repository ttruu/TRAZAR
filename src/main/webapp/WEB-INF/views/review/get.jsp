			...
			$.ajax({
				...
				success : function(list) {
					...
					for (let i = 0; i < list.length; i++) {
						...
						$("#reviewContent" + list[i].id).text(list[i].content);
		...
		<div class="row">
			<div class="col">
				<form id="insertReviewForm1">
					<div class="input-group">
						<input type="hidden" name="boardId" value="${board.id }" />
						<input id="insertReviewContentInput1" class="form-control" type="text" name="content" required />
						<button id="addReviewSubmitButton1" class="btn btn-outline-secondary">
							<i class="fa-solid fa-comment-dots"></i>
						</button>
					</div>
				</form>
