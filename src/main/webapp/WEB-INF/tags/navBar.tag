...
<header id="nav-header" class="border-bottom fixed">
	<div class="container">
		...
		<div
			...
			<a href="/trazar/designBoard/list"
				class="d-flex align-items-center mb-3 mb-lg-0 text-dark text-decoration-none">
				<svg class="bi me-2" width="40" height="32" role="img"
					aria-label="Bootstrap">
					<img src="${appRoot}/resources/picture/logo/악.PNG" /></svg>
			</a>

			<ul id="front-nav-font"
				class="nav col-12 col-lg-auto me-lg-auto mb-2 justify-content-center mb-md-0">
				<li>
					<a href="${noticeListUrl }" class="nav-link px-2 link-light">공지사항</a>
				</li>
				<li>
			...
			<sec:authorize access="not isAuthenticated()">
				<ul class="nav nav-pills" id="front-nav-font">
					<li class="nav-item ">
						<a href="${loginUrl }" class="nav-link link-light">로그인</a>
					</li>
					<li class="nav-item ">
			...
			<sec:authorize access="isAuthenticated()">
				<div class="dropdown text-end">
					<a href="#"
						class="d-block link-dark text-decoration-none dropdown-toggle text-light"
						id="dropdownUser1" data-bs-toggle="dropdown" aria-expanded="false">
						<i class="fa-solid fa-circle-user text-light"></i>
					</a>
					<ul class="dropdown-menu text-small" id="front-nav-font"
						aria-labelledby="dropdownUser1">
						<li>
							<a class="dropdown-item" data-bs-toggle="modal"
								data-bs-target="#modal3" href="${passwordModify }">비밀번호 변경</a>
						</li>
						<li>
							<a class="dropdown-item" href="${myListUrl }">내 의뢰목록</a>
						</li>
						<li>
							<a class="dropdown-item" data-bs-toggle="modal"
